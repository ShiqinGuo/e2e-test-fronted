...
The complete product uses two repositories: [FastAPI backend + runtimes](https://github.com/ShiqinGuo/e2e-test-svc) and [React workbench](https://github.com/ShiqinGuo/e2e-test-fronted). This repository contains the **web workbench**. Its companion is [e2e-test-svc](https://github.com/ShiqinGuo/e2e-test-svc).
